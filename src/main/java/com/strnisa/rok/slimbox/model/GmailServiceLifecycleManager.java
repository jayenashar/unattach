...
class GmailServiceLifecycleManager {
  private static final String GOOGLE_APPLICATION_NAME = "Slimbox";
  private static final File DATA_STORE_DIR = new File(System.getProperty("user.home"), ".credentials/slimbox");
